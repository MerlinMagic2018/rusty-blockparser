...
impl Coin for Lightningcash {
    fn name(&self) -> String {
        String::from("Lightningcash")
    }
    fn magic(&self) -> u32 {
        0xeaccf6d9
    }
    ...
    fn genesis(&self) -> [u8; 32] {
        utils::hex_to_arr32_swapped(
            "a1d8b56639865905eef9205e148bad0c6a4b2026b1753c76558bb735c3e9735c",
        )
    }
    fn default_folder(&self) -> PathBuf {
        Path::new(".lightningcash").join("blocks")
    }
}

impl Coin for Triangles {
    fn name(&self) -> String {
        String::from("Triangles")
    }
    fn magic(&self) -> u32 {
        0x05223570
    }
    ...
    fn default_folder(&self) -> PathBuf {
        Path::new(".triangles").join("blocks")
    }
}
...
impl FromStr for CoinType {
    ...
    fn from_str(coin_name: &str) -> OpResult<Self> {
        match coin_name {
            ...
            "lightningcash" => Ok(CoinType::from(Lightningcash)),
            "triangles" => Ok(CoinType::from(Triangles)),
            n => {
